    ...
    <section id="contests" className="relative">
      <div className="container py-12 sm:py-16 lg:py-24">
        <div className="flex flex-col lg:flex-row justify-between items-center gap-8 md:gap-16">
          <div className="flex-1 text-center lg:text-left max-w-none">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-5">
              Ijodiy <span className="text-blue-600">tanlovlar</span>
            </h2>
          ...
          <div className="flex-1 flex justify-center w-full">
            <div className="w-full max-w-[520px] rounded-[32px] bg-white p-4 shadow-lg ring-1 ring-black/5">
              <img
        ...
        <div className="mt-14 lg:mt-24">
          <div className="relative bg-gray-50 rounded-3xl md:rounded-[32px] lg:rounded-[40px] p-6 lg:p-8 overflow-hidden border border-gray-100 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
              <div className="bg-white flex flex-col items-center text-center gap-5 rounded-[28px] py-6 px-4 border border-gray-100 shadow-sm">
              ...
              <div className="bg-white flex flex-col items-center gap-5 rounded-[28px] py-6 px-4 border border-gray-100 shadow-sm">
                <div className="flex-shrink-0">
                  <img
