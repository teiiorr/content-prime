...
export const InternationalPartnershipSlugPage = memo(
  function InternationalPartnershipSlugPage({
    newsItem,
  }: {
                ...
                <p className="text-lg lg:text-xl text-gray-700 mb-4 lg:mb-6">
                  ...
                  {newsItem.id === 1 && (
                    <>
                      ...
                      qarori ijrosini taʼminlash maqsadida quyidagi
                      yoʻnalishlarda ijodiy tanlovlarni eʼlon qilishni
                      rejalashtirmoqda:
                    </>
                  )}
                </p>
